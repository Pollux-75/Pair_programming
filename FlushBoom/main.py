...
ai_pk = pygame.image.load('./images/tags/' + 'AI大战.jpg')
pos_ai_pk = (430, 535)
size_ai_pk = (220, 76)
# 设置按钮阴影大小
size_shadow = (25, 25)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:  # 点击关闭窗口
                ...
                if event.button == 1:  # 左键点击
                    ...
                    elif event.pos[0] in range(pos_ai_pk[0] + size_shadow[0],
                                               pos_ai_pk[0] + size_shadow[0] + pos_ai_pk[0]) \
                            and event.pos[1] in range(pos_ai_pk[1] + size_shadow[1],
                                                      pos_ai_pk[1] + size_shadow[1] + pos_ai_pk[1]):
                        print('动作：点击AI大战')
                        ai_pk_ai()
                ...
                if event.button == 1:  # 左键点击
                    ...
                    if event.pos[0] in range(pos_hosting[0], pos_hosting[0] + size_hosting[0]) \
                        ...
                        break
                            ...
                            and event.pos[1] in range(pos_cancal_hosting[1],
                                                      pos_cancal_hosting[1] + size_cancal_hosting[1]):
                        mark_ai = 0
                        break
                    elif event.pos[0] in range(327, 327 + 105) and event.pos[1] in range(287, 287 + 150):
                        if turn == 0:
